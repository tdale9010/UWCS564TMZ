DROP PROCEDURE `dbo`.`Add_Tag`;
DROP PROCEDURE `dbo`.`Autocomplete_Actor`;
DROP PROCEDURE `dbo`.`Autocomplete_City`;
DROP PROCEDURE `dbo`.`Autocomplete_Country`;
DROP PROCEDURE `dbo`.`Autocomplete_Director`;
DROP PROCEDURE `dbo`.`Autocomplete_Genre`;
DROP PROCEDURE `dbo`.`Autocomplete_Region`;
DROP PROCEDURE `dbo`.`Autocomplete_Tag`;
DROP PROCEDURE `dbo`.`Favorite_Film_Delete`;
DROP PROCEDURE `dbo`.`Favorite_Films`;
DROP PROCEDURE `dbo`.`Favorite_Films_Insert`;
DROP PROCEDURE `dbo`.`Favorite_Genre`;
DROP PROCEDURE `dbo`.`Favorite_Genre_Delete`;
DROP PROCEDURE `dbo`.`Favorite_Genre_Insert`;
DROP PROCEDURE `dbo`.`Favorite_Tag`;
DROP PROCEDURE `dbo`.`Favorite_Tag_Delete`;
DROP PROCEDURE `dbo`.`Favorite_Tag_Insert`;
DROP PROCEDURE `dbo`.`Movie_Info`;
DROP PROCEDURE `dbo`.`Search_Results`;
DROP PROCEDURE `dbo`.`Search_Results_Full_Info`;
DROP PROCEDURE `dbo`.`Tag_Movie`;
DROP PROCEDURE `dbo`.`Tag_Movie_Remove`;
DROP PROCEDURE `dbo`.`User_Info`;
DROP PROCEDURE `dbo`.`User_Info_Create_All`;
DROP PROCEDURE `dbo`.`User_Info_Delete_All`;
DROP PROCEDURE `dbo`.`User_Info_Next_ID`;
DROP PROCEDURE `dbo`.`User_Info_Update_Name`;
DROP PROCEDURE `dbo`.`User_Info_Update_Password`;
DROP PROCEDURE `dbo`.`User_Info_Update_Rating`;
...
DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `Search_Results_Full_Info`(IN TitleIn VARCHAR(254), IN RatingIn Decimal(5,4),
 IN DirectorIn VARCHAR(254), IN GenreIn VARCHAR(254), IN ActorIn Varchar(254), IN FilmLocationIn Varchar(254),
 IN CountryIn VARCHAR(254), IN TagIn Varchar(254))
BEGIN
		SELECT distinct m.title as 'Title',m.rating as 'Rating',d.Name as 'Director',
